...
/**
 * Class drsoftfrvalidatecustomer
 */
class drsoftfrvalidatecustomer extends Module
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->moduleGithubRepositoryUrl = 'https://github.com/drsoft-fr/drsoftfrvalidatecustomer';
        $this->moduleGithubIssuesUrl = 'https://github.com/drsoft-fr/drsoftfrvalidatecustomer/issues';
        $this->isPsVersion8 = (bool)version_compare(_PS_VERSION_, '8.0', '>=');

        parent::__construct();

        $this->description = $this->trans('Validate customer at registration and assign groups automatically.', [], 'Modules.Drsoftfrvalidatecustomer.Admin');
        $this->displayName = $this->trans('drSoft.fr Validate Customer', [], 'Modules.Drsoftfrvalidatecustomer.Admin');

        $this->confirmUninstall = $this->trans('Are you sure you want to uninstall?', [], 'Modules.Drsoftfrvalidatecustomer.Admin');
    }
    ...
    /**
     * Redirects the admin user to the ValidateCustomer controller in the admin panel.
     *
     * @return void
     */
