...
namespace DrSoftFr\Module\ValidateCustomer\Form\DataProvider;
...
/**
 * Class SettingFormDataProvider is in charge of accessing/saving the ValidateCustomer settings in PrestaShop configuration
 */
