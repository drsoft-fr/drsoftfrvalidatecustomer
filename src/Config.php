...
namespace DrSoftFr\Module\ValidateCustomer;
...
final class Config
{
    const ERROR_MESSAGE_PATTERN = 'drsoftfrvalidatecustomer - %s - %d - Throwable #%d - %s.';

    const INSTALLER_SERVICE = 'drsoft_fr.module.validate_customer.install.installer';

    const SETTING_PROVIDER_SERVICE = 'drsoft_fr.module.validate_customer.data.setting_data_provider';
