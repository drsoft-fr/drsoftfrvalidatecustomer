...
use DrSoftFr\Module\ValidateCustomerProB2B\Config;
use DrSoftFr\Module\ValidateCustomerProB2B\Controller\Admin\AdapterCustomerController;
use DrSoftFr\Module\ValidateCustomerProB2B\Controller\Admin\IndexController;
use DrSoftFr\Module\ValidateCustomerProB2B\Controller\Admin\SettingController;
use DrSoftFr\Module\ValidateCustomerProB2B\Controller\Hook\ActionAuthenticationController;
use DrSoftFr\Module\ValidateCustomerProB2B\Controller\Hook\ActionCustomerAccountAddController;
use DrSoftFr\Module\ValidateCustomerProB2B\Controller\Hook\ActionFrontControllerSetVariablesController;
use DrSoftFr\Module\ValidateCustomerProB2B\Controller\Hook\ActionListMailThemesController;
use DrSoftFr\Module\ValidateCustomerProB2B\Controller\Hook\ActionObjectCustomerDeleteAfterController;
use DrSoftFr\Module\ValidateCustomerProB2B\Controller\Hook\ActionObjectUpdateAfterController;
use DrSoftFr\Module\ValidateCustomerProB2B\Install\Factory\InstallerFactory;
use DrSoftFr\Module\ValidateCustomerProB2B\Install\Installer;
...
/**
 * Class drsoftfrvalidatecustomerprob2b
 */
class drsoftfrvalidatecustomerprob2b extends Module
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->bootstrap = true;
        $this->confirmUninstall = $this->trans('Are you sure you want to uninstall?', [], 'Modules.Drsoftfrvalidatecustomerprob2b.Admin');
        $this->dependencies = [];
        $this->description = $this->trans('Validate customer at registration and assign groups automatically.', [], 'Modules.Drsoftfrvalidatecustomerprob2b.Admin');
        $this->displayName = $this->trans('drSoft.fr Validate Customer Pro B2B', [], 'Modules.Drsoftfrvalidatecustomerprob2b.Admin');
        $this->name = 'drsoftfrvalidatecustomerprob2b';
        ...
        $this->tabs = [
            [
                ...
                'name' => 'Validate Customer Pro B2B',
                'parent_class_name' => 'AdminParentCustomer',
                'route_name' => 'admin_drsoft_fr_validate_customer_pro_b2b_index',
                'visible' => true,
            ],
            [
        ...
        $this->moduleGithubRepositoryUrl = 'https://github.com/drsoft-fr/drsoftfrvalidatecustomerprob2b';
        $this->moduleGithubIssuesUrl = 'https://github.com/drsoft-fr/drsoftfrvalidatecustomerprob2b/issues';
            ...
            $this->handleException(
                new Exception(
                    $this->trans(
                        ...
                        [],
                        'Modules.Drsoftfrvalidatecustomerprob2b.Error'
                    )
                )
            );
    ...
    /**
     * Redirects the admin user to the ValidateCustomerProB2B controller in the admin panel.
     *
     * @return void
     */
